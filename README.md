...
Spring Data | .epub | .pdf | .html | .html single | [build & BOM](https://github.com/spring-projects/spring-data-build) | [examples](https://github.com/spring-projects/spring-data-examples)
