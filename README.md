...
[Spring Data (Commons)](http://projects.spring.io/spring-data/) | .epub | .pdf | - | [.html single](http://docs.spring.io/spring-data/commons/docs/current/reference/html/) | sources | examples repository
